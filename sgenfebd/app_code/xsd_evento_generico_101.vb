...
Namespace EventoXsd
    ...
    Partial Public Class TRetEventoInfEvento
        ...
        Private cOrgaoAutorField As TCOrgaoIBGE

        Private cOrgaoAutorFieldSpecified As Boolean
        ...
        '''<remarks/>
        Public Property cOrgaoAutor() As TCOrgaoIBGE
            Get
                Return Me.cOrgaoAutorField
            End Get
            Set(ByVal value As TCOrgaoIBGE)
                Me.cOrgaoAutorField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlIgnoreAttribute()> _
        Public Property cOrgaoAutorSpecified() As Boolean
            Get
                Return Me.cOrgaoAutorFieldSpecified
            End Get
            Set(ByVal value As Boolean)
                Me.cOrgaoAutorFieldSpecified = Value
            End Set
        End Property
